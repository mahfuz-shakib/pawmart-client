    ...
    <>
      <form onSubmit={handleFormInfo}>
        <fieldset className="fieldset ">
          ...
          <div className="w-full flex flex-col md:flex-row gap-2 md:gap- justify-between">
          ...
          <button className="btn mx-auto w-full md:w-sm bg-grad text-white mt-1 md:mt-4 hover:scale-102">Place Order</button>
        </fieldset>
      </form>
    </>
  );
