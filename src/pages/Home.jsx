          ...
          <Container>
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Getting started with PawMart is simple. Follow these easy steps to find your perfect pet companion or
              ...
              {[
                {
                  ...
                  title: "Browse & Search",
                  description:
                    "Explore our wide selection of pets and products. Use filters to find exactly what you're looking for.",
                  icon: "🔍",
                ...
                },
                {
                  ...
                  title: "View Details",
                  description:
                    "Click on any listing to see full details, photos, location, and contact information of the owner.",
                  icon: "👁️",
                ...
                },
                {
                  ...
                  title: "Place Order",
                  description:
                    "Fill out the order form with your details and submit your adoption request or purchase order.",
                  icon: "📝",
